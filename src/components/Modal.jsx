...
import { addNewSong } from '../Redux/Slices/songsListSlice'
...
export default function CustomizedDialogs() {
    ...
    const [songSource, setSongSource] = React.useState('')
                    ...
                    <Grid container>
                        <Grid columns={12} md={12}>
                            <Grid sx={{ mb: 2, mt: 0.5 }}>
                                ...
                                <TextField variant='outlined' size='small' type='text' onChange={(e) => setSongName(e.target.value)} fullWidth placeholder='Song Name' />
                            </Grid>
                            <Grid sx={{ mb: 2 }}>
                                <Typography variant='body1' gutterBottom>
                                    Song Link
                                </Typography>
                                <TextField variant='outlined' size='small' type='text' onChange={(e) => setSongLink(e.target.value)} fullWidth placeholder='URL' />
                            </Grid>
                            <Grid sx={{ mb: 2 }}>
                                <Typography variant='body1' gutterBottom>
                                    Source Name
                                </Typography>
                                <TextField variant='outlined' size='small' type='text' onChange={(e) => setSongSource(e.target.value)} fullWidth placeholder='Source Name' />
                            </Grid>
                            ...
                            <Grid sx={{ mb: 2 }}>
                                <Button component="label" variant="outlined"
                                    ...
                                    sx={{
                                        textTransform: 'capitalize', color: 'black', borderColor: grey['A400'],
                                        '&:hover': {
